...
/**
 * Vtiger VTAP webhook tokens, extracted from VTController::tokens.
 *
 * Each key is a webhook endpoint name; the value is the auth token
 * passed in the HTTP `token` header.
 */
return [
