...
trait Deal
{
    ...
    private function build_deal_payload($deal_stage, $deal_close_date)
    {
        $request_body = [
        ...
        } elseif ($this->isset_data('num_of_students')) {
    ...
    {
        $request_body = $this->build_deal_payload($deal_stage, $deal_close_date);
