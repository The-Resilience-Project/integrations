...
class PrizePackRequestTest extends TestCase
{
    ...
    {
        $request = PrizePackRequest::fromFormData($this->makeFormData());
    ...
    public function test_from_form_data_extracts_source_form(): void
    {
        ...
        $this->assertSame('NSWPDPN Delegate 2026', $request->sourceForm);
    }

    public function test_optional_fields_default_to_null(): void
    {
        $request = PrizePackRequest::fromFormData([
    ...
    public function test_throws_when_email_is_empty(): void
    {
        ...
        PrizePackRequest::fromFormData($this->makeFormData(['contact_email' => '']));
    }
