...
class TrpDates
{
    ...
    protected function get_org_id()
    {
        ...
        if (str_starts_with($potential_id, 'ACC')) {
            ...
            curl_setopt_array($request_handle, [
                ...
                CURLOPT_POSTFIELDS => json_encode(['organisationAccountNo' => $potential_id]),
    ...
    protected function get_school_name()
    {
        ...
        curl_setopt_array($request_handle, [
            CURLOPT_CUSTOMREQUEST => $request_method,
            CURLOPT_POSTFIELDS => json_encode(['organisationId' => $this->org_id]),
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_HEADER => false,
            CURLOPT_HTTPHEADER => $request_header,
        ]);
    ...
    public function populate_form()
    {
        ...
        $id_lookup = [
            'Teacher Wellbeing Workshop 1 - Looking after Yourself' => [
                'Webinar' => [6, 'Teacher Wellbeing 1: Looking After Yourself', 'staff'],
                'In person' => [7, 'Teacher Wellbeing 1: Looking After Yourself', 'staff'],
            ],
            'Teacher Wellbeing Workshop 2 - Looking After Each Other' => [
                'Webinar' => [8, 'Teacher Wellbeing 2: Looking After Each Other', 'staff'],
                'In person' => [9, 'Teacher Wellbeing 2: Looking After Each Other', 'staff'],
            ],
            'Teacher Wellbeing Workshop 3 - Sharing Success' => [
                'Webinar' => [10, 'Teacher Wellbeing 3: Sharing Success', 'staff'],
                'In person' => [11, 'Teacher Wellbeing 3: Sharing Success', 'staff'],
            ],
            'Staff Authentic Connection Presentation' => [
                'Webinar' => [12, 'Authentic Connection for Staff', 'staff'],
            ],
            'Building Resilience at Home for Parents and Carers' => [
            ...
            'Connected Parenting' => [
                'Webinar' => [16, 'Connected Parenting with Lael Stone', 'parents'],
            ],
            'Digital Wellbeing for Families' => [
                'Webinar' => [17, 'Digital Wellbeing for Families', 'parents'],
                'In person' => [18, 'Digital Wellbeing for Families', 'parents'],
            ],
        ];
