...
class TrpSingleDates
{
    ...
    protected function get_event()
    {
        ...
        curl_setopt_array($request_handle, [
            ...
            CURLOPT_POSTFIELDS => json_encode(['eventId' => $event_id]),
    ...
    protected function check_contact()
    {
        ...
        curl_setopt_array($request_handle, [
            CURLOPT_CUSTOMREQUEST => $request_method,
            CURLOPT_POSTFIELDS => json_encode(['contactId' => $contact_id]),
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_HEADER => false,
            CURLOPT_HTTPHEADER => $request_header,
        ]);
    ...
    public function populate_form()
    {
        ...
        $id_lookup = [
            'Teacher Wellbeing Workshop 1 - Looking after Yourself' => ['Teacher Wellbeing 1: Looking After Yourself', 'Staff'],
            'Teacher Wellbeing Workshop 2 - Looking After Each Other' => ['Teacher Wellbeing 2: Looking After Each Other', 'Staff'],
            'Teacher Wellbeing Workshop 3 - Sharing Success' => ['Teacher Wellbeing 3: Sharing Success', 'Staff'],
            'Staff Authentic Connection Presentation' => ['Authentic Connection for Staff', 'Staff'],
            'Resilience Network' => ['Resilience Network', 'Staff'],
            'Embedding TRP' => ['Embedding TRP', 'Staff'],
